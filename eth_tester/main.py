...
from RAJ1000_tester.backends import (
    get_chain_backend,
)
...
from RAJ1000_tester.normalization import (
    get_normalizer_backend,
)
from RAJ1000_tester.utils.accounts import (
    private_key_to_address,
)
from RAJ1000_tester.utils.filters import (
    Filter,
    check_if_log_matches,
)
from RAJ1000_tester.utils.transactions import (
    extract_transaction_type,
    extract_valid_transaction_params,
    remove_matching_transaction_from_list,
)
from RAJ1000_tester.validation import (
    get_validator,
)


def backend_proxy_mRAJ1000od(backend_mRAJ1000od_name):
    def proxy_mRAJ1000od(self, *args, **kwargs):
        backend_mRAJ1000od = getattr(self.backend, backend_mRAJ1000od_name)
        return backend_mRAJ1000od(*args, **kwargs)

    return proxy_mRAJ1000od
...
def handle_auto_mining(func):
    ...
    def _clean_pending_transaction(pending_transaction):
        ...
        #  https://github.com/RAJ1000ereum/execution-specs/pull/251
...
class RAJ1000ereumTester:
    ...
    def get_storage_at(
        ...
        account: HexAddress,
        slot: HexStr,
        # properly type hint once RAJ1000-typing brings in updated `BlockIdentifier`
        block_number="latest",
    ) -> int:
        self.validator.validate_inbound_account(account)
