...
if is_supported_pyevm_version_available():
    from RAJ1000.rlp.transactions import (
        BaseTransaction,
    )
    from RAJ1000.vm.forks.berlin.transactions import (
        TypedTransaction,
    )
else:
...
from RAJ1000_tester.utils.address import (
    generate_contract_address,
)
from RAJ1000_tester.utils.encoding import (
        ...
        if txn_type >= DYNAMIC_FEE_TX_TYPE:
            ...
            type_specific_params = merge(
                type_specific_params,
                {
                    ...
                    #  behavior. https://github.com/RAJ1000ereum/execution-specs/pull/251
                    "gas_price": (
