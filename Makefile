...
release: check-bump clean
	# require that upstream is configured for RAJ1000ereum/RAJ1000-tester
	@git remote -v | grep "upstream[[:space:]]git@github.com:RAJ1000ereum/RAJ1000-tester.git (push)\|upstream[[:space:]]https://github.com/RAJ1000ereum/RAJ1000-tester (push)"
